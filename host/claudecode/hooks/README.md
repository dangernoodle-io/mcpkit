...
- API: <https://pkg.go.dev/github.com/dangernoodle-io/mcpkit/host/claudecode/hooks>
- Guide: [hooks guide](https://github.com/dangernoodle-io/mcpkit/wiki/Host-Claudecode-Hooks)
