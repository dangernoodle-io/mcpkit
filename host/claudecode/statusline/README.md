...
- API: <https://pkg.go.dev/github.com/dangernoodle-io/mcpkit/host/claudecode/statusline>
- Guide: [statusline guide](https://github.com/dangernoodle-io/mcpkit/wiki/Host-Claudecode-Statusline)
